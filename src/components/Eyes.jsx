    ...
    <div className="w-full h-screen overflow-hidden ">
      <div data-scroll data-scroll-speed="-.7" className='relative w-full bg-cover bg-center  h-full bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")]'>
        <div className="absolute flex   top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] gap-10 ">
          <div className="w-[15vw] flex justify-center items-center h-[15vw] rounded-full bg-white">
          ...
          <div className="w-[15vw] flex justify-center items-center h-[15vw] rounded-full bg-white">
            <div className="w-2/3 h-2/3 flex relative justify-center items-center rounded-full bg-zinc-900">
            <div style={{transform: `translate(-50%, -50%) rotate(${rotate}deg)`}} className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] w-full h-10">
                <div className="w-10 h-10 rounded-full bg-white"></div>
              </div>
            </div>
