...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen p-20  bg-zinc-900">
      <div className="w-1/2 flex flex-col justify-between h-full font-[Roboto]">
        <div>
          <h1 className="text-[8vw] leading-none font-semibold uppercase -mb-5">
            Eye-
          </h1>
          <h1 className="text-[8vw] leading-none font-semibold uppercase -mb-5">
            Opening
      ...
      <div className="w-1/2 ">
        <h1 className="text-[6vw] tracking-[-0.5rem] leading-none font-semibold uppercase -mb-5">
          PRESENTATIONS
        </h1>
        ...
        <div className="flex justify-between">
          ...
          <p className="mb-5">M:</p>
                {["Home", "Services", "Our work", "About us", "Insights", "Contact us"].map((item, index) => <p className="underline cursor-pointer">{item}</p>)}
          </div>
        </div>
      </div>
    </div>
